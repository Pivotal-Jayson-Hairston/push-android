...
public class RegistrationEngineTestParameters {
    ...
    public void run() {
        ...
        final PushParameters parameters = new PushParameters(gcmSenderIdFromUser, platformUuidFromUser, platformSecretFromUser, serviceUrlFromUser, deviceAliasFromUser, tagsFromUser, areGeofencesEnabledFromUser, true, Pivotal.SslCertValidationMode.DEFAULT, null, null);
