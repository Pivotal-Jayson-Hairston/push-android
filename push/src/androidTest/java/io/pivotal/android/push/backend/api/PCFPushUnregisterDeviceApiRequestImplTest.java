...
public class PCFPushUnregisterDeviceApiRequestImplTest extends AndroidTestCase {
    ...
    protected void setUp() throws Exception {
        super.setUp();
        parameters = new PushParameters(TEST_GCM_SENDER_ID, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, TEST_DEVICE_ALIAS, null, true, true, Pivotal.SslCertValidationMode.DEFAULT, null, null);
    ...
    public void testSuccessfulRequestWithCustomRequestHeaders() {
        ...
        parameters = new PushParameters(TEST_GCM_SENDER_ID, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, TEST_DEVICE_ALIAS, null, true, false, Pivotal.SslCertValidationMode.DEFAULT, null, requestHeaders);
        final PCFPushUnregisterDeviceApiRequestImpl request = new PCFPushUnregisterDeviceApiRequestImpl(getContext(), networkWrapper);
        request.startUnregisterDevice(TEST_PCF_PUSH_DEVICE_REGISTRATION_ID, parameters, PCFPushUnregisterDeviceListener);
        delayedLoop.startLoop();
        assertTrue(delayedLoop.isSuccess());
    ...
    public void testSuccessfulRequestSsl() {
        parameters = new PushParameters(TEST_GCM_SENDER_ID, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, TEST_DEVICE_ALIAS, null, true, true, Pivotal.SslCertValidationMode.TRUST_ALL, null, null);
