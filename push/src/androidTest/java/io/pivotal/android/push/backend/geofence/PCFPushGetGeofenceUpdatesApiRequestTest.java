...
public class PCFPushGetGeofenceUpdatesApiRequestTest extends AndroidTestCase {
    ...
    private PushParameters getParameters() {
        return new PushParameters(null, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, null, null, true, true, false, null, null);
    }

    private PushParameters getParameters(Map<String, String> requestHeaders) {
        return new PushParameters(null, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, null, null, true, false, false, null, requestHeaders);
    }
}
