...
//    }
    ...
    private PushParameters getParameters(boolean areAnalyticsEnabled) {
        return new PushParameters(TEST_SENDER_ID, TEST_PLATFORM_UUID, TEST_PLATFORM_SECRET, TEST_SERVICE_URL, TEST_DEVICE_ALIAS, null, true, areAnalyticsEnabled, false, null);
    }
}